...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    if (results && results.length > 0) {
      ...
      const newValues = ['blood_pressure_systolic', 'blood_pressure_diastolic'];
  ...
  async down(queryInterface, Sequelize) {
    ...
    console.warn('Manual intervention required to remove: blood_pressure_systolic, blood_pressure_diastolic');
