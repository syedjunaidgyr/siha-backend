...
- **Backend**: `http://35.154.207.79:4000`
- **AI Service**: `http://35.154.207.79:3001`
...
- `AIAnalysisService`: `http://35.154.207.79:3001/api`
- `PreventiveHealthService`: `http://35.154.207.79:3001/api`
...
env: {
  AI_SERVICE_PYTHON_URL: 'http://35.154.207.79:3001/api'
}
...
curl http://35.154.207.79:3001/health
