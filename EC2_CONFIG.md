...
- **Backend**: `http://13.200.84.19:4000`
- **AI Service**: `http://13.200.84.19:3001`
...
- `AIAnalysisService`: `http://13.200.84.19:3001/api`
- `PreventiveHealthService`: `http://13.200.84.19:3001/api`
...
env: {
  AI_SERVICE_PYTHON_URL: 'http://13.200.84.19:3001/api'
}
...
curl http://13.200.84.19:3001/health
...
2. Change from:
   ```typescript
   const DEFAULT_AI_BASE_URL = 'http://13.200.84.19:3001/api';
   ```
