...
- **Backend**: `http://13.203.232.71:4000`
- **AI Service**: `http://13.203.232.71:3001`
...
- `AIAnalysisService`: `http://13.203.232.71:3001/api`
- `PreventiveHealthService`: `http://13.203.232.71:3001/api`
...
env: {
  AI_SERVICE_PYTHON_URL: 'http://13.203.232.71:3001/api'
}
...
curl http://13.203.232.71:3001/health
